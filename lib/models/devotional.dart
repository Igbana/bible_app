...
class Devotional {
  ...
  int? id;
  String date, title, memoryVerse, memoryVersePassage, fullPassage;
  ...
  @override
  String toString() {
    return 'DevotionalModel{int: $id, date: $date, title: $title, memoryVerse: $memoryVerse, memoryVersePassage: $memoryVersePassage, fullPassage: $fullPassage, fullText: $fullText, bibleInAYear: $bibleInAYear, image: $image, prayerBurden: $prayerBurden, thoughtOfTheDay: $thoughtOfTheDay,}';
  }
